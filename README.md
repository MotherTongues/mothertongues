...
1. `mothertongues new-project`
2. Then run your dictionary: `mothertongues build-and-run <YourDictionaryConfigDirPath>/config.mtd.json`
...
4. Install the Python package: `cd .. && uv sync`
